...
# ISTA_min_distances = np.load('/Users/elad.sofer/src/ADVERSARIAL_SENSITIVTY/stack/version1/matrices/ISTA_total_norm.npy')
# ADMM_min_distances = np.load('/Users/elad.sofer/src/ADVERSARIAL_SENSITIVTY/stack/version1/matrices/ADMM_total_norm.npy')
